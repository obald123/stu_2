...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 to-white flex items-center justify-center py-12 sm:px-6 lg:px-8 relative">
      {/* Removed small watermark/illustration for a cleaner look as requested */}
