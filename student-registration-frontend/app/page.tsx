...
export default function Home() {
  ...
  return (
    <Box sx={{ minHeight: '100vh', bgcolor: '#f4f6fb', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', py: 6 }}>
      {loading ? (
        <LoadingSpinner size={56} />
      ) : isAuthenticated && isAdmin ? (
        // Admin Home
        <Box sx={{ width: '100%', maxWidth: 520, mx: 'auto', bgcolor: '#fff', border: '1px solid #e0e7ef', boxShadow: 2, borderRadius: 4, p: { xs: 3, sm: 6 }, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 3 }}>
          <Logo size={56} />
        ...
        <Box sx={{ width: '100%', maxWidth: 520, mx: 'auto', bgcolor: '#fff', border: '1px solid #e0e7ef', boxShadow: 2, borderRadius: 4, p: { xs: 3, sm: 6 }, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 3 }}>
          <Logo size={56} />
          <Typography variant="h3" fontWeight={800} color="primary" align="center" sx={{ letterSpacing: 1, fontSize: { xs: '2rem', sm: '2.5rem' } }}>
